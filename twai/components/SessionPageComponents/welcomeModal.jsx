...
export default function WelcomeModal() {
    ...
    const steps = [
        ...
        {
            title: "How to Use TalkWise AI",
            content: (
                <div className="space-y-4">
                    {[
                        { Icon: Mic, title: "Connect Microphone", text: "Use the microphone button to record your voice during the interview. Your speech will be transcribed in real-time." },
                        { Icon: MonitorSmartphone, title: "Capture Screen", text: "Share your screen to capture both audio and video from your meeting. Make sure to select 'Share tab audio' when prompted." },
                        { Icon: Bot, title: "AI Assistance", text: "Ask questions or get help from the AI assistant. Use the quick action buttons for summaries, fact-checking, and more." },
        ...
        },
        {
            ...
            content: (
                <div className="space-y-4">
                    {[
                        { title: "Highlight Text", text: "Highlight any text in the conversation to automatically copy it. Then enable the 'Highlighted' option when asking questions." },
                        { title: "Web Search & RAG", text: "Enable web search for up-to-date information. Use RAG (Retrieval Augmented Generation) to leverage your uploaded documents." },
                        { title: "Save Your Work", text: "Your conversation is automatically saved. You can access a summary and review the session later from your dashboard." },
                    ].map(({ title, text }, idx) => (
                        <div key={idx} className="flex items-start gap-3 p-3 border rounded-lg">
                            <div className="bg-primary/10 p-2 rounded-full">
            ...
            <div className="bg-white rounded-lg shadow-lg w-full max-w-2xl max-h-[90vh] overflow-hidden">
                ...
                <div className="flex justify-between items-center p-4 border-t bg-gray-50">
                    ...
                    <div className="flex space-x-1">
                        {steps.map((_, index) => (
                            <div key={index} className={`h-2 w-2 rounded-full ${index === currentStep ? "bg-primary" : "bg-gray-300"}`} />
                        ))}
                    </div>
